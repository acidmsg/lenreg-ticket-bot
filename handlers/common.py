...
from utils.cache import delete_cache_key, spam_cache, update_cache_key
...
async def cmd_status(message: Message, db: DatabaseManager, api: ZdravClient):
    """Отображает статус бота."""
    report = format_status_report(api, db)
