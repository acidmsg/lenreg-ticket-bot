...
| OPT-L | Добавить `-> None` аннотации возвращаемого типа к 112 async-функциям без аннотаций (23 файла) — подготовка к `--disallow-untyped-defs` | [`manager.py`](src/database/manager.py) (13), [`common.py`](src/handlers/common.py) (19), ещё 21 файл (80) | Стандартизация | ⬜     |
