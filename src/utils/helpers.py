...
SPECIALTY_ALIASES = {
    ...
    "Клиническая лабораторная диагностика": "Врач КЛД",
    "Лечебная физкультура и спортивная медицина": "Врач ЛФК",
    ...
    "Скорая медицинская помощь": "Врач скорой помощи",
    "Стоматология общей практики": "Стоматолог",
    "Стоматология ортопедическая": "Стоматолог-ортопед",
    "Стоматология детская": "Дет. стоматолог",
    "Стоматология профилактическая": "Стоматолог-профилактик",
    ...
    "Ультразвуковая диагностика": "УЗИ-диагност",
    "Урология": "Уролог",
    "Физиотерапия": "Физиотерапевт",
    "Фтизиатрия": "Фтизиатр",
    "Функциональная диагностика": "Врач функц. диагностики",
    "Хирургия": "Хирург",
