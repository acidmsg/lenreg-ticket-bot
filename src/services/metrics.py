...
class PrometheusMetrics:
    ...
    def __init__(self) -> None:
        ...
        self._slots_found_total: Any = Counter(
            "lenreg_ticket_slots_found_total",
            "Счётчик найденных слотов",
        )
        self._api_requests_total: Any = Counter(
            "lenreg_ticket_api_requests_total",
    ...
    async def _sync_counters(self) -> None:
        ...
        async with metrics_lock:
            ...
            if delta_hc > 0:
                ...
                logger.debug("Сброс lenreg_ticket_healthcheck_errors_total")
            ...
            if delta_slots > 0:
                ...
                logger.debug("Сброс lenreg_ticket_slots_found_total")
            ...
            if delta_api > 0:
                ...
                logger.debug("Сброс lenreg_ticket_api_requests_total")
            ...
            if delta_err > 0:
                ...
                logger.debug("Сброс lenreg_ticket_api_errors_total")
